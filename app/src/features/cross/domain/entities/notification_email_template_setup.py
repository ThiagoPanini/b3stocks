...
class NotificationEmailTemplateSetup:
    ...
    Attributes:
        template_endpoint_url (Optional[str]):
            The endpoint URL of the custom HTML template.
        template_placeholders (Optional[dict[str, Any]]):
            Placeholders to replace in the custom HTML template.
    """
